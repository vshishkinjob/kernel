...
final class Phone implements RuleInterface, SkipOnEmptyInterface, MessageValidationInterface, WhenInterface
{
    ...
    public function __construct(
        ...
        public readonly string $regEx = "/^(\+\d{1,2}\s?)?1?\-?\.?\s?\(?\d{3}\)?[\s.-]?\d{3}[\s.-]?\d{4}$/",
        public readonly string $message = 'Формат телефона должен быть: +77777777777',
